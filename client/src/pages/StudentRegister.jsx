      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-semibold tracking-tight text-slate-900 mb-2">Join CampusHub</h1>
            <p className="text-sm text-slate-500">Register to RSVP for events and get reminders.</p>
          </div>
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link to="/login" state={{ from: redirectTo }} className="text-[#2E5AA7] font-medium hover:underline">
              Log in
            </Link>
          </p>
        </motion.div>
